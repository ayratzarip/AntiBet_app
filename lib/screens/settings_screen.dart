...
Используйте функцию "Скопировать для AI", чтобы получить профессиональный анализ Ваших записей. Вставьте скопированный текст в чат с ChatGPT или Claude для выявления скрытых паттернов и получения рекомендаций.''',
            ),
            const SizedBox(height: AppSpacing.lg),
            _buildSection(
              context,
